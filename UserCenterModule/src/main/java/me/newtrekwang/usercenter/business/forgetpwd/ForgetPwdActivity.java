 ...
 * @desc 注册验证码验证界面
 */
@Route(path = RouterPath.UserCenterModule.PATH_FORGET_PWD)
public class ForgetPwdActivity extends BaseMvpActivity<ForgetPwdPresenter> implements ForgetPwdView, ButtonUtil.ButtonEnable {
    ...
    private void initView() {
        etPhoneNum = findViewById(R.id.forget_pwd_et_phone);
        etCode = findViewById(R.id.forget_pwd_et_code);
        etPwd = findViewById(R.id.forget_pwd_et_pwd);
        etPwdAgain = findViewById(R.id.forget_pwd_et_pwd_again);
        validateButton = findViewById(R.id.forget_pwd_btn_get_code);
        btnRegister = findViewById(R.id.forget_pwd_btn_register);
